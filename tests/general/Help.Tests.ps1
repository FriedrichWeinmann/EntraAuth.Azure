...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\EntraAuth.Azure\functions", "$global:testroot\..\EntraAuth.Azure\internal\functions"),
	
	[string]
	$ModuleName = "EntraAuth.Azure",
...
$CommandPath = @(
    "$global:testroot\..\EntraAuth.Azure\functions"
    "$global:testroot\..\EntraAuth.Azure\internal\functions"
)
