...
Remove-Module EntraAuth.Azure -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\EntraAuth.Azure\EntraAuth.Azure.psd1"
Import-Module "$PSScriptRoot\..\EntraAuth.Azure\EntraAuth.Azure.psm1" -Force
